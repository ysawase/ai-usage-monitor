...
pub struct Strings {
    ...
    pub reset_display: &'static str,
    pub reset_display_relative: &'static str,
    pub reset_display_datetime: &'static str,
    pub reset_datetime_day: &'static str,
    pub reset_datetime_month_day: &'static str,
    pub reset_datetime_year_month_day: &'static str,
    pub reset_time_hour: &'static str,
    pub reset_time_hour_minute: &'static str,
